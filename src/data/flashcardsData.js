export const flashcardsData = {
  math: [
    ...
    {
      id: 'm11',
      front: '等量公理解未知數方程式之四大運算準則？',
      back: '• 等量加法/減法：等號兩邊同加或同減同一數，等式依然成立 (x - a = b ➔ x = b + a)\n• 等量乘法/除法：等號兩邊同乘或同除以同一「不為 0」的數，等式依然成立 (ax = b ➔ x = b ÷ a)\n⚠️ 陷阱：0 絕對不能當除數！',
      tag: '等量公理'
    },
    {
      id: 'm12',
      front: '圓形百分圖與圓心角換算公式？',
      back: '• 全圓代表 100%，圓心角總和 360°\n• 圓心角計算：圓心角 = 360° × 百分率\n• 百分率計算：百分率 = 項目數量 ÷ 全體總數量 × 100%\n• 各部分百分率總和必等於 100%',
      tag: '統計圖表'
    }
  ],
  ...
  science: [
    ...
    {
      id: 's9',
      front: '聲音三要素與自製樂器音調高低規律？',
      back: '• 聲音三要素：響度（振幅大小）、音調（振動頻率 Hz）、音色（波形材質）\n• 弦樂器高音口訣：弦越【緊】、越【細】、振動長度越【短】，音調越高！\n• 管樂器吹奏口訣：空氣柱越【短】，振動頻率越快，音調越高！',
      tag: '聲學樂器'
    },
    {
      id: 's10',
      front: '顯微鏡倍率換算與高倍鏡操作口訣？',
      back: '• 總放大倍率 = 目鏡倍率 × 物鏡倍率 (10X × 40X = 400倍)\n• 切換高倍鏡後：視野變【暗】、範圍變【小】、細胞變【大】且數量變【少】\n• 倒立像移動口訣：「物往哪跑，玻片就往哪追」（像在右上，玻片往右上移）',
      tag: '顯微鏡微生物'
    }
  ],
  ...
  mandarin: [
    ...
    {
      id: 'c7',
      front: '傳統書信信封啟封詞與生活題辭要領？',
      back: '• 啟封詞：長輩用「鈞啟/安啟」、平輩用「大啟」。⚠️ 絕對不可寫「敬啟」（敬啟是請對方恭敬拆開，不合禮儀）\n• 常見題辭：\n  - 賀新居落成：華廈鼎新、喬遷之喜\n  - 賀教育界：杏壇之光、桃李芬芳\n  - 賀生男：弄璋之喜；賀生女：弄瓦之喜',
      tag: '應用文禮儀'
    },
    {
      id: 'c8',
      front: '漢字「六書」造字原則與唐詩常識？',
      back: '• 六書造字法：象形（日/月）、指事（上/下/刃）、會意（休/武）、形聲（江/河/櫻，占80%以上）\n• 用字之法：轉注、假借\n• 唐代詩人雅稱：李白（詩仙）、杜甫（詩聖）、王維（詩佛，詩中有畫畫中有詩）',
      tag: '六書與國學'
    }
  ],
  ...
  social: [
    ...
    {
      id: 'so7',
      front: '全球七大洲五大洋與經典世界文明？',
      back: '• 七大洲：亞洲（面積最大人口最多）、非洲、北美洲、南美洲、南極洲、歐洲、大洋洲\n• 五大洋：太平洋（最大最深）、大西洋、印度洋、南冰洋、北極洋\n• 經典古文明：埃及古文明（尼羅河、金字塔）、兩河流域（美索不達米亞）、亞馬遜雨林（地球之肺）',
      tag: '世界地理文化'
    },
    {
      id: 'so8',
      front: '數位足跡、資訊倫理與防詐三不原則？',
      back: '• 數位足跡 (Digital Footprint)：網路搜尋、打卡、留言皆永久留存，應謹慎保護隱私\n• 著作權尊重：引用他人圖文影音務必取得授權或使用 CC 創用標示作者出處\n• 防詐騙口訣：不點可疑連結、不透露個資密碼、多方求證（撥打 165 反詐騙專線）',
      tag: '資訊科技倫理'
    }
  ],
  ...
  english: [
    ...
    {
      id: 'e9',
      front: 'Future Tense: will vs. be going to (未來式用法)',
      back: '• will + 原形動詞: 表達說話當下的決定、預測或承諾 (I will help you.)\n• be going to + 原形動詞: 表達事先已規劃的計畫或有明顯跡象的未來 (I am going to visit Grandma this Sunday.)\n• 時間副詞: tomorrow, next week/year, in the future',
      tag: 'Future Tense'
    },
    {
      id: 'e10',
      front: 'Comparative & Superlative Adjectives (形容詞比較級與最高級)',
      back: '• 比較級 (二者相比): A is taller than B. / more expensive than\n• 最高級 (三者以上/群體第一): the tallest / the most expensive in the world\n• 高頻不規則變化: \n  - good ➔ better ➔ best\n  - bad ➔ worse ➔ worst\n  - many/much ➔ more ➔ most',
      tag: 'Comparisons'
    }
  ],
  ...
  arts: [
    ...
    {
      id: 'a5',
      front: '定格動畫 (Stop Motion) 原理與擬音藝術？',
      back: '• 視覺暫留：人眼殘留影像約 0.1 秒，連續快速播放（如 12~24 FPS 影格）融合成動態\n• FPS (Frames Per Second)：每秒放映的影格張數\n• 擬音藝術 (Foley)：運用生活物品模擬逼真聲效（如揉捏澱粉包模擬踏雪聲、敲椰子殼模擬馬蹄聲）',
      tag: '數位多媒體'
    },
    {
      id: 'a6',
      front: '臺灣傳統布袋戲行當與寺廟剪黏工藝？',
      back: '• 布袋戲五大行當：生（男子）、旦（女子）、淨（花臉剛烈）、末（老者）、丑（幽默詼諧滑稽）\n• 皮影戲三要素：影偶（精雕皮革著色）、光源、白色影幕\n• 剪黏工藝：將彩色陶瓷碗片碎剪拼貼於寺廟屋脊，呈現龍鳳吉祥雕飾',
      tag: '傳統工藝偶戲'
    }
  ],
  ...
  health_pe: [
    ...
    {
      id: 'p5',
      front: '團隊球類戰術「傳切配合」與運動前後伸展？',
      back: '• 傳切配合 (Give and Go)：傳球給隊友 ➔ 快速切入空檔 ➔ 重新接球得分！\n• 運動前【動態伸展】：慢跑踢腿活化關節與肌肉溫度預防受傷\n• 運動後【靜態伸展】：溫和拉筋停留 15~30 秒，加速乳酸代謝減緩延遲性酸痛',
      tag: '團隊球類防護'
    },
    {
      id: 'p6',
      front: '壓力調適「4-7-8 呼吸法」與「成長型思維」？',
      back: '• 4-7-8 呼吸放鬆法：吸氣 4 秒 ➔ 憋氣 7 秒 ➔ 緩慢吐氣 8 秒，啟動副交感神經降血壓心率\n• 成長型思維 (Growth Mindset)：相信大腦智力如肌肉可鍛鍊，「我不是不行，只是『尚未』學會！」\n• 心理求助安心專線：1925（依舊愛我）',
      tag: '心理健康調適'
    }
  ],
  ...
  integrative: [
    ...
    {
      id: 'i5',
      front: '事實查核四部曲與用眼 3010 護眼原則？',
      back: '• 事實查核四步：冷靜懷疑 ➔ 檢視來源 ➔ 多方交叉比對 (查核中心) ➔ 查證無誤再分享\n• 3010 護眼原則：看 3C 螢幕每 30 分鐘，遠眺 6 公尺外放鬆 10 分鐘\n• 反網路霸凌三不一留：不跟風、不轉發、不隱忍；截圖存證求助師長或 1953',
      tag: '媒體素養健康'
    },
    {
      id: 'i6',
      front: '無痕山林 (LNT) 與野外迷途 STOP 原則？',
      back: '• 無痕山林首要準則：行前充分的規劃與準備 (Plan Ahead and Prepare)\n• 野外迷途 STOP 原則：\n  - S (Stop 停止移動原地待援)\n  - T (Think 冷靜思考)\n  - O (Observe 觀察周遭資源環境)\n  - P (Plan 制定避難保暖求救計畫)\n• 洋蔥式穿法：內層排汗、中層保暖、外層防風防水',
      tag: '戶外探險安全'
    }
  ]
};
